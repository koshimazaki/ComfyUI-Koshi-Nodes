...
class TestGlitchCandiesPatterns2D:
    ...
    def test_2d_pattern_output_shape(self, pattern):
        ...
        result = unwrap_output(node.generate(
...
class TestGlitchCandiesBatch:
    ...
    def test_seed_determinism(self):
        ...
        node = KoshiGlitchCandies()
        r1 = unwrap_output(node.generate(
            width=64, height=64, pattern="swirl",
            time=1.0, scale=1.0, seed=123,
        ))
        r2 = unwrap_output(node.generate(
            width=64, height=64, pattern="swirl",
            time=1.0, scale=1.0, seed=123,
        ))
...
class TestKoshiShapeMorph:
    ...
    def test_blend_zero_equals_image_a(self):
        ...
        result = unwrap_output(node.morph(image_a=a, image_b=b, blend=0.0, blend_mode="linear"))
        output = result[0]
    ...
    def test_blend_one_equals_image_b(self):
        ...
        result = unwrap_output(node.morph(image_a=a, image_b=b, blend=1.0, blend_mode="linear"))
        output = result[0]
    ...
    def test_all_blend_modes_run(self, mode):
        ...
        a = _make_image(batch=1, h=32, w=32)
        b = _make_image(batch=1, h=32, w=32)
        result = unwrap_output(node.morph(image_a=a, image_b=b, blend=0.5, blend_mode=mode))
...
class TestKoshiNoiseDisplace:
    ...
    def test_output_shape_matches_input(self):
        ...
        result = unwrap_output(node.displace(
            image=image,
            strength=0.1,
            scale=10.0,
            octaves=4,
